"""
Django settings for qhse_45381 project.
...
WSGI_APPLICATION = 'qhse_45381.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qhse_45381 API",
    "DESCRIPTION": "API documentation for qhse_45381 App",
    "VERSION": "v1",
}
